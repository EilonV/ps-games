...
export const Boot = ({ setIsBooted }) => {

    const load = () => {
        setIsBooted(true)
    }

    return <section className="ps-load flex column justify-center">
        <div className="ps-center flex column align-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48" onClick={load}>
            ...
            <div className="faded-circle circle" />
        </div>
        {/* <div className="canvas-wrapper">
            <Spline scene="https://prod.spline.design/eNrXl019tYrFM1V6/scene.splinecode" />
        </div> */}
    </section>
}